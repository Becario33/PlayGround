...
Top 10 películas por taquilla Comscore (antier) en SQL Server: se arma un Excel, se captura y **la imagen** se manda al grupo **Data Analytics** por WhatsApp Web. Chrome persistente: QR **una vez** (carpeta `chrome_whatsapp_perfil/`, no tu Chrome de diario).
...
1. Corre el TOP 10 por taquilla (antier, hoy-2).
...
| Parte | Cómo |
|--------|------|
| SQL | TOP 10 por `Taquilla` de antier (`FechaComscore` hoy-2) |
...
- **v1.6.2** — Filtro antier (FechaComscore hoy-2)
